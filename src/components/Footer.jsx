...
const Footer = () => {
    ...
    return (
        <footer id='footer' className='w-screen relative bg-gray-500 py-4 text-black flex flex-col items-center justify-around'>
            ...
            >
                ...
                <div>
                    ...
                    <ul className='flex flex-col gap-4 md:text-xl sm:text-lg '>
                        ...
                        <li className='relative group'>
                            <Link to="/products" className='text-gray-300 cursor-pointer'>Mejoras ventanas en Asturias</Link>
                            <span className="absolute -bottom-1 left-0 w-0 h-1 bg-white transition-all group-hover:w-full"></span>
                        </li>
                    </ul>
                </div>
                ...
                <div className='flex flex-col items-center justify-start md:justify-center gap-4 sm:items-center mb-4 '>
                    ...
                    <div className='flex flex-row gap-6'>                     
                        ...
                        <a href='https://www.facebook.com/share/16RxyCY7uB/' className="w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300 hover:scale-125">
                        ...
                        <a href='https://www.instagram.com/viktoriiaventanas_?igsh=dzVkaTNkMzNobjM4' className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-500 hover:scale-125">
            ...
            <p>
                &copy; 2025 Viktoria Ventanas. All rights reserved.
            </p>
        </footer>
    )
}
