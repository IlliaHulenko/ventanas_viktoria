            ...
            >
                ...
                <div className='flex flex-col items-center justify-start md:justify-center gap-4 sm:items-center mb-4 '>
                    ...
                    <div className='flex flex-row gap-6'>                     
                        ...
                        <a href='https://www.instagram.com/' className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-500 hover:scale-125">
                        ...
                        <a href='https://www.twitter.com/' className="w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-300 hover:scale-125">
